...
public class NeuTextView extends AppCompatTextView implements NeumorphismImpl {
    ...
    public NeuTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray attrArray = context.obtainStyledAttributes(attrs,R.styleable.NeuTextView);
        neuElevation = attrArray.getDimension(R.styleable.NeuTextView_neu_elevation,(int) utilities.dpToPx(6f));
        neuRadius = attrArray.getDimension(R.styleable.NeuTextView_neu_radius,utilities.dpToPx(8f));
        backgroundColor = attrArray.getColor(R.styleable.NeuTextView_neu_background_color,ContextCompat.getColor(getContext(),R.color.md_grey_100));
        lightShadowColor = attrArray.getColor(R.styleable.NeuTextView_neu_light_shadow_color,ContextCompat.getColor(getContext(),R.color.white));
        darkShadowColor = attrArray.getColor(R.styleable.NeuTextView_neu_dark_shadow_color,ContextCompat.getColor(getContext(),R.color.md_grey_300));
        attrArray.recycle();
    ...
    private int calculateMinWidth(DisplayMetrics metrics, Rect textBounds, int neuElevation)
    {
        ...
        {
            int masterWidth = (int) (textBounds.width() + utilities.dpToPx(16) + calculateDrawableWidth() + getCompoundDrawablePadding() + neuElevation*5);
    ...
    private int calculateMinHeight(DisplayMetrics metrics, Rect textBounds, int neuElevation)
    {
        ...
        if (getText().length() > 0)
        {
            int masterLineWidth = (int) (metrics.widthPixels - neuElevation*5 - utilities.dpToPx(16) - calculateDrawableWidth());
    ...
    public void setPadding(int left, int top, int right, int bottom) {
        left = (int) (left + neuElevation*2.5 + utilities.dpToPx(4));
        top = (int) (top + neuElevation*2.5 + utilities.dpToPx(4));
        right = (int) (right + neuElevation*2.5 + utilities.dpToPx(4));
        bottom = (int) (bottom + neuElevation*2.5 + utilities.dpToPx(4));
        super.setPadding(left, top, right, bottom);
    }

    @Override
    public void setPaddingRelative(int start, int top, int end, int bottom) {
        start = (int) (start + neuElevation*2.5 + utilities.dpToPx(4));
        top = (int) (top + neuElevation*2.5 + utilities.dpToPx(4));
        end = (int) (end + neuElevation*2.5 + utilities.dpToPx(4));
        bottom = (int) (bottom + neuElevation*2.5 + utilities.dpToPx(4));
    ...
    {
        return (int) (getPaddingTop() - neuElevation*2.5 - utilities.dpToPx(4));
    }
    ...
    {
        return (int) (getPaddingStart() - neuElevation*2.5 - utilities.dpToPx(4));
    }
    ...
    {
        return (int) (getPaddingEnd() - neuElevation*2.5 - utilities.dpToPx(4));
    }
    ...
    {
        return (int) (getPaddingBottom() - neuElevation*2.5 - utilities.dpToPx(4));
    }
