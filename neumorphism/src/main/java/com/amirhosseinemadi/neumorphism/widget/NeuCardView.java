...
public class NeuCardView extends FrameLayout implements NeumorphismImpl {
    ...
    public NeuCardView(@NonNull Context context) {
        super(context);
    ...
    public NeuCardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        metrics = getContext().getResources().getDisplayMetrics();
        utilities = new Utilities(metrics);

        TypedArray attrArray = context.obtainStyledAttributes(attrs,R.styleable.NeuCardView);
        neuElevation = attrArray.getDimension(R.styleable.NeuCardView_neu_elevation,(int) utilities.dpToPx(6f));
        neuRadius = attrArray.getDimension(R.styleable.NeuCardView_neu_radius,utilities.dpToPx(8f));
        backgroundColor = attrArray.getColor(R.styleable.NeuCardView_neu_background_color, ContextCompat.getColor(getContext(),R.color.md_grey_100));
        lightShadowColor = attrArray.getColor(R.styleable.NeuCardView_neu_light_shadow_color,ContextCompat.getColor(getContext(),R.color.white));
        darkShadowColor = attrArray.getColor(R.styleable.NeuCardView_neu_dark_shadow_color,ContextCompat.getColor(getContext(),R.color.md_grey_300));
        attrArray.recycle();
